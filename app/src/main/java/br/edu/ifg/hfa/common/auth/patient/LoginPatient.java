    ...
    public void letTheUserLoggedIn(View view) {
        ...
        checkUser.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    ...
                    if (systemPassword.equals(_password)) {
                        ...
                        //Create a Session
                        SessionManager sessionManager = new SessionManager(LoginPatient.this, SessionManager.SESSION_USERSESSION);
                        sessionManager.createLoginSession(_name, _cpf, _email, _phoneNo, _password, _dateOfBirth, _gender);
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                progressbar.setVisibility(View.GONE);
                Toast.makeText(LoginPatient.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
